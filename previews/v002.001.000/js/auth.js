(function () {
    ...
    var endpoints = {
        login: "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v002.001.000/v1/auth/login",
        forgot: "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v002.001.000/v1/auth/forgot-password",
        reset: "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v002.001.000/v1/auth/reset-password",
        verify: "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v002.001.000/v1/auth/verify-email",
        resend: "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v002.001.000/v1/auth/resend-verification"
    };
    ...
    function nextUrl(form) {
        ...
        var next = params.get("next") || form.dataset.successRedirect || "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v002.001.000/pages/app/index.html";
        return next.charAt(0) === "/" && next.charAt(1) !== "/" ? next : "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v002.001.000/pages/app/index.html";
    }
    ...
    async function submitForm(form) {
        ...
        try {
            ...
            if (kind === "forgot") {
                ...
                navigateWithTransition(successRedirect(form, "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v002.001.000/pages/auth/password-reset-success.html"), 350);
                return;
            } else if (kind === "verify") {
                setStatus(
                    form,
