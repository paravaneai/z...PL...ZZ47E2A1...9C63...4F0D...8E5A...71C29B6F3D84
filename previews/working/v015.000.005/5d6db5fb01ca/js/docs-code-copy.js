(function () {
    ...
    function addCommandCopyControl(command, index) {
        ...
        if (!code || command.querySelector("[data-docs-copy-code]")) return;
    ...
    function init() {
        ...
        Array.prototype.slice.call(document.querySelectorAll(".page-developers .dev-command, .page-open-source .dev-command")).forEach(addCommandCopyControl);
    }
