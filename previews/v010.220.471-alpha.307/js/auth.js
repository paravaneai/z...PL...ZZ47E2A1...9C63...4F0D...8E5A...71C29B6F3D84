(function () {
    ...
    var endpoints = {
        login: "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v010.220.471-alpha.307/v1/auth/login",
        forgot: "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v010.220.471-alpha.307/v1/auth/forgot-password",
        reset: "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v010.220.471-alpha.307/v1/auth/reset-password",
        verify: "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v010.220.471-alpha.307/v1/auth/verify-email",
        resend: "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v010.220.471-alpha.307/v1/auth/resend-verification"
    };
    ...
    function completeVerificationPage(form, result) {
        ...
        if (actions) {
            ...
            if (nextLink) {
                if (active) {
                    nextLink.href = "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v010.220.471-alpha.307/pages/auth/login.html?next=%2Fpages%2Fapp%2Fapi-keys.html";
                    nextLink.textContent = "Sign in to create API key";
                } else if (billingRequired) {
                    nextLink.href = "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v010.220.471-alpha.307/pages/auth/login.html?next=%2Fpages%2Fapp%2Fbilling.html";
                    nextLink.textContent = "Sign in to complete billing";
                } else {
                    nextLink.href = "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v010.220.471-alpha.307/index.html";
    ...
    function nextUrl(form) {
        ...
        var next = params.get("next") || form.dataset.successRedirect || "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v010.220.471-alpha.307/pages/app/index.html";
        return next.charAt(0) === "/" && next.charAt(1) !== "/" ? next : "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v010.220.471-alpha.307/pages/app/index.html";
    }
    ...
    async function submitForm(form) {
        ...
        try {
            ...
            if (kind === "forgot") {
                ...
                navigateWithTransition(successRedirect(form, "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v010.220.471-alpha.307/pages/auth/password-reset-success.html"), 350);
                return;
            } else if (kind === "verify") {
