(function () {
    ...
    function initAccountSettings() {
        if (!$("[data-account-settings]")) return;
        var user = (portalSession && portalSession.user) || {};
        var tenant = (portalSession && portalSession.tenant) || {};
        setText("[data-settings-user-name]", user.name || user.email);
        setText("[data-settings-user-email]", user.email);
        setText("[data-settings-user-status]", formatLabel(user.status || "active"));
        setText("[data-settings-tenant-name]", tenant.name);
        setText("[data-settings-plan]", planLabel(tenant.plan || "FREE"));
        setText("[data-settings-tenant-status]", formatLabel(tenant.status || "active"));
        setStatus("", "success");
        hideAppTransition();
    }
    function initLogout() {
