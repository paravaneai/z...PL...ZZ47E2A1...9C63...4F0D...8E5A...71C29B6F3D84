(function () {
    ...
    function isPlatformPathname(pathname) {
        return pathname === "/" || pathname === "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v008.003.000/index.html";
    }
    ...
    function escapeHtml(value) {
        return String(value == null ? "" : value)
            ...
            .replace(/</g, "&lt;")
            .replace(/>/g, "&gt;")
            .replace(/"/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v008.003.000/g, "&quot;")
            .replace(/'/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v008.003.000/g, "&#39;");
    }
    ...
    function redirectToLogin() {
        var next = window.location.pathname || "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v008.003.000/pages/app/index.html";
        window.location.href = "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v008.003.000/pages/auth/login.html?next=" + encodeURIComponent(next);
    }
    ...
    async function initDashboard() {
        ...
        try {
            var data = await requestJson("/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v008.003.000/v1/app/summary");
    ...
    async function initUsagePage() {
        ...
        renderTableSkeleton("[data-usage-rows]", 4, 4);
        try {
            var data = await requestJson("/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v008.003.000/v1/app/usage");
            var usage = data.usage || {};
    ...
    async function loadApiKeys() {
        ...
        var data = await requestJson("/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v008.003.000/v1/app/api-keys");
    ...
    function initCreateApiKeyForm() {
        ...
        form.addEventListener("submit", async function (event) {
            ...
            try {
                ...
                var result = await requestJson("/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v008.003.000/v1/app/api-keys", {
                    method: "POST",
                    headers: {
                ...
                var refreshed = await requestJson("/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v008.003.000/v1/app/api-keys");
    ...
    function initApiKeyActions() {
        ...
        if (renameForm) {
            renameForm.addEventListener("submit", async function (event) {
                ...
                try {
                    await requestJson("/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v008.003.000/v1/app/api-keys/" + encodeURIComponent(renameKeyId), {
                        method: "PATCH",
                        headers: {
                            "Accept": "application/json",
                            "Content-Type": "application/json"
        ...
        document.addEventListener("click", async function (event) {
            ...
            try {
                await requestJson("/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v008.003.000/v1/app/api-keys/" + encodeURIComponent(id) + "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v008.003.000/revoke", { method: "POST" });
                await loadApiKeys();
    ...
    async function initBillingPage() {
        ...
        try {
            var data = await requestJson("/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v008.003.000/v1/billing/status");
            renderBilling(data);
        ...
        document.querySelectorAll("[data-checkout-plan]").forEach(function (button) {
            button.addEventListener("click", async function () {
                ...
                try {
                    var result = await requestJson("/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v008.003.000/v1/billing/checkout", {
                        method: "POST",
                        headers: {
                            "Accept": "application/json",
                            "Content-Type": "application/json"
        ...
        if (portalButton) {
            portalButton.addEventListener("click", async function () {
                ...
                try {
                    var result = await requestJson("/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v008.003.000/v1/billing/portal", { method: "POST" });
    ...
    function initAccountDeletion() {
        ...
        form.addEventListener("submit", async function (event) {
            ...
            try {
                await requestJson("/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v008.003.000/v1/app/account", {
                    method: "DELETE",
                ...
                clearSensitiveSessionState();
                try {
                    await requestJson("/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v008.003.000/v1/auth/logout", { method: "POST" });
                } catch (err) {}
                showAppTransition();
                var loginUrl = new URL("/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v008.003.000/pages/auth/login.html?account=deleted", window.location.href);
    ...
    function initLogout() {
        document.querySelectorAll("[data-logout]").forEach(function (button) {
            button.addEventListener("click", async function () {
                ...
                var loginUrl = new URL("/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v008.003.000/pages/auth/login.html", window.location.href);
                writePageArrivalState(loginUrl);
                window.location.href = loginUrl.href;
            });
        });
