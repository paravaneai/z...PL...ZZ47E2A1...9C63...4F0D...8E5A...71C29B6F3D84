(function () {
    ...
    var endpoints = {
        contact: "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v003.011.001/v1/contact",
        signup: "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v003.011.001/v1/signup",
        demo: "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v003.011.001/v1/demo/score"
    };
    ...
    function renderDemoResult(form, result) {
        ...
        el.innerHTML = [
            ...
            '<div class="demo-result-actions">',
                '<a class="text-link" href="signup.html">Request full access</a>',
                '<a class="text-link" href="docs.html">View API docs</a>',
            '</div>'
        ].join("");
    }
    ...
    function escapeHtml(value) {
        return String(value)
            ...
            .replace(/</g, "&lt;")
            .replace(/>/g, "&gt;")
            .replace(/"/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v003.011.001/g, "&quot;")
            .replace(/'/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v003.011.001/g, "&#39;");
    }
        ...
        try {
            ...
            if (kind === "demo") {
                ...
                setStatus(
                    form,
                    kind === "signup"
                        ? "Your evaluation request was received. Paravane Labs will review it before access is activated."
                        : "Message received. Paravane Labs will follow up by email.",
                    "success"
                );
            }
        } catch (err) {
            setStatus(form, err.message || "Something went wrong. Please email info@doydl.studio.", "error");
        } finally {
            resetTurnstile(form);
            setBusy(form, false);
        }
