    ...
    function renderDemoResult(form, result) {
        ...
        el.innerHTML = [
            ...
            '<section class="demo-api-upgrade" aria-labelledby="demo-api-upgrade-title">',
                ...
                '</div>',
                '<a class="demo-api-upgrade-docs-link" href="../pages/docs/smtprs/quickstart">Read smtpRS API documentation <i class="fa-solid fa-arrow-right" aria-hidden="true"></i></a>',
            '</section>'
        ].join("");
    }
