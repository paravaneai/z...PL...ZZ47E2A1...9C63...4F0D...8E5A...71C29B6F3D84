...
(function () {
    ...
    const theme = {
        ...
        assets: {
            ...
            primaryLogo: assetUrl("../assets/brand/paravane-brandmark-extended-stem-orange-solid.svg"),
            darkLogo: assetUrl("../assets/brand/paravane-brandmark-extended-stem-orange-solid.svg"),
            lightLogo: assetUrl("../assets/brand/paravane-brandmark-extended-stem-orange-solid.svg"),
            iconLogo: assetUrl("../assets/brand/paravane-brandmark-compact-stem-orange-yellow-gradient-01.svg"),
            favicon: assetUrl("../assets/brand/paravane-brandmark-compact-stem-orange-yellow-gradient-transparent.ico"),
            appleTouchIcon: assetUrl("../assets/brand/paravane-brandmark-compact-stem-orange-yellow-gradient-01.png"),
            wordmark: assetUrl("../assets/brand/paravane-brandmark-extended-stem-orange-solid.svg"),
            socialCard: assetUrl("../assets/brand/paravane-social-card.png"),
        },
        links: {
            /*
