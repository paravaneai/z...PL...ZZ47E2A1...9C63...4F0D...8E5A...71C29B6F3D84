(function () {
    ...
    var endpoints = {
        contact: "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v010.220.482-alpha.402/v1/contact",
        signup: "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v010.220.482-alpha.402/v1/signup",
        demo: "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v010.220.482-alpha.402/v1/demo/score"
    };
    ...
    function renderDemoResult(form, result) {
        ...
        el.innerHTML = [
            ...
            '<div class="demo-result-actions">',
                '<a class="text-link" href="/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v010.220.482-alpha.402/pages/auth/register.html">Request full access</a>',
                '<a class="text-link" href="/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v010.220.482-alpha.402/pages/docs/index.html">View API docs</a>',
            '</div>'
        ].join("");
    }
        ...
        try {
            ...
            if (kind === "demo") {
                ...
                setStatus(
                    form,
                    kind === "signup"
                        ? "Registration received. Check your email to verify the account and continue to activation, billing, or review."
