(function () {
    ...
    var endpoints = {
        contact: "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v003.015.000/v1/contact",
        signup: "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v003.015.000/v1/signup",
        demo: "/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v003.015.000/v1/demo/score"
    };
        ...
        try {
            ...
            if (kind === "demo") {
                ...
                setStatus(
                    form,
                    kind === "signup"
                        ? "Your evaluation request was received. Check your email to verify the account while Paravane Labs reviews access."
