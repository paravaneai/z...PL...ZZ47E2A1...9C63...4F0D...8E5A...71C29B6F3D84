        ...
        products: {
            ...
            items: {
                ...
                emailValidation: {
                    ...
                    pagePath: "pages/api/email-verification-validation-api.html",
                    pathHints: ["email-verification-validation-api", "email-validation"],
                    aliases: ["Email Validation", "Email Validation API", "Email Verification"],
                },
                emailReputation: {
                    enabled: false,
        ...
        pages: {
            ...
            items: {
                guides: {
                    ...
                    pathHints: ["/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v003.000.000/guides", "guides.html"],
                },
                integrations: {
                    enabled: false,
                    name: "Integrations",
                    ...
                    pathHints: ["/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v003.000.000/integrations", "integrations.html"],
                },
                resources: {
                    enabled: false,
                    name: "Resources",
                    ...
                    pathHints: ["/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v003.000.000/resources", "resources.html"],
                },
                domainReputationChecker: {
                    ...
                    pathHints: ["/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v003.000.000/domain-reputation-checker", "domain-reputation-checker.html"],
                },
                companyEnrichmentPage: {
                    ...
                    pathHints: ["/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v003.000.000/api/company-enrichment", "api/company-enrichment.html"],
                },
                emailReputationPage: {
                    enabled: false,
                    ...
                    pathHints: ["/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v003.000.000/api/email-reputation-api", "api/email-reputation-api.html"],
                },
                customerRiskAssessment: {
                    ...
                    pathHints: ["/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v003.000.000/solutions/customer-risk-assessment", "solutions/customer-risk-assessment.html"],
                },
                paymentFraudDetection: {
                    ...
                    pathHints: ["/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v003.000.000/solutions/payment-fraud-detection", "solutions/payment-fraud-detection.html"],
                },
                disposableEmailChecker: {
                    ...
                    pathHints: ["/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v003.000.000/tools/disposable-email-checker", "tools/disposable-email-checker.html"],
                },
                dmarcCheck: {
                    enabled: false,
                    name: "DMARC Check",
                    ...
                    pathHints: ["/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v003.000.000/tools/dmarc-check", "tools/dmarc-check.html"],
                },
                domainAgeChecker: {
                    enabled: false,
                    ...
                    pathHints: ["/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v003.000.000/tools/domain-age-checker", "tools/domain-age-checker.html"],
                },
                proxyDetector: {
                    enabled: false,
                    name: "Proxy Detector",
                    ...
                    pathHints: ["/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v003.000.000/tools/proxy-detector", "tools/proxy-detector.html"],
                },
                spfCheck: {
                    enabled: false,
                    name: "SPF Check",
                    ...
                    pathHints: ["/z...PL...ZZ47E2A1...9C63...4F0D...8E5A...71C29B6F3D84/previews/v003.000.000/tools/spf-check", "tools/spf-check.html"],
                },
            },
        },
        features: {
    ...
    const applyProductAvailability = () => {
        ...
        document.querySelectorAll(".nav-link-subtext-2").forEach((element) => {
            if (
                ...
                element.textContent = "Useful guides about our Email Validation API.";
            }
        });
