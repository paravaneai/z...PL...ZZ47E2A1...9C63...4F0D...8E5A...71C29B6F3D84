(function () {
    ...
    function application(job) {
        return '<div class="form-shell careers-form-shell"><form id="careers-form" class="site-form" action="../v1/careers/apply" method="post" enctype="multipart/form-data" data-api-form="careers" data-success-redirect="../pages/careers/jobs/application-received/" aria-label="Application for ' + esc(job.title) + '">' +
            ...
            '<label class="field"><span>First name</span><input type="text" name="first_name" autocomplete="given-name" maxlength="60" required></label>' +
            '<label class="field"><span>Last name</span><input type="text" name="last_name" autocomplete="family-name" maxlength="80" required></label>' +
    ...
    function addJobSchema(job) {
        var schema = {"@context":"https://schema.org","@type":"JobPosting","title":job.title,
            ...
            "directApply":true,"hiringOrganization":{"@type":"Organization","name":"Paravane Labs","sameAs":"https://paravane.io/","logo":"https://paravane.io../../../shared/53/5324d7fe22bb243f1b8198e1552ef6818428086c753da78222be42bdeccddd26.png"},
        ...
        var node = document.querySelector("script[data-job-schema]") || document.createElement("script");
    ...
    function loadJobs() {
        return fetch("../v1/careers/jobs", {credentials:"same-origin", headers:{"Accept":"application/json"}}).then(function (response) {
            ...
            return fetch("../data/jobs.json?v=v013.000.007-seo", {credentials:"same-origin"}).then(function (response) {
                if (!response.ok) throw new Error(); return response.json();
            });
        });
    }
