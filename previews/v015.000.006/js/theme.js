(function () {
    ...
    function bindMobileNavigation() {
        ...
        function stabilizeMobileMenuScrollOrigin() {
            var visibleHeight = Math.ceil(header.getBoundingClientRect().height);
            ...
            if (visibleHeight > 0) {
                root.style.setProperty("--site-header-visible-height", visibleHeight + "px");
            }
        }
        ...
        function setCatalogOpen(open, restoreFocus) {
            ...
            window.dispatchEvent(new CustomEvent("paravane:mobile-nav-statechange", {
                detail: { open: true, catalogOpen: open }
            }));
