 ...
 * Original file: /npm/macy@2.5.0/dist/macy.js
 *
        ...
        M(t, o, e),
            v(n, function (n) {
                ...
                (e = parseInt(n.offsetHeight, 10)),
                    isNaN(e) ||
                        ((n.style.position = "absolute"), (n.style.top = t.rows[t.lastcol] + "px"), (n.style.left = "" + t.cols[t.lastcol]), (t.rows[t.lastcol] += isNaN(e) ? 0 : e + i), (t.lastcol += 1), r && (n.dataset.macyComplete = 1));
            }),
            r && (t.tmpRows = null),
            l(t);
    }
